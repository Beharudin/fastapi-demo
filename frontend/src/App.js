        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              View inventory and manage products with edit/delete modals.
            </p>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewProduct({ description: e.target.value })
                      }
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewProduct({ quantity: e.target.value })
                      }
                      required
                    />
                  </div>
            ...
            <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[min(95%,28rem)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border bg-card p-6 shadow-2xl">
              <div className="mb-4">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  ...
                  <strong>{selectedProduct?.name}</strong>? This action cannot
                  be undone.
                </p>
              </div>
              <div className="flex justify-end gap-2 pt-2">
